            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-contract me-2"></i>Tambah Dokumen Kapal</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dokumen-kapal.store') }}" method="POST" id="dokumenKapalForm"
                                    ...
                                    <div class="card h-100 border-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="no_reg" class="form-label fw-bold">Nomor Registrasi <span
                                                    ...
                                                    <select class="form-select @error('nama_kpl') is-invalid @enderror"
                                                        ...
                                                        @foreach ($kapal as $ship)
                                                            <option value="{{ $ship->id_kode }}"
                                                                {{ old('nama_kpl') == $ship->id_kode ? 'selected' : '' }}>
                                                                {{ $ship->nama_kpl }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select class="form-select @error('kategori_dok') is-invalid @enderror"
                                                        ...
                                                        @foreach ($kategoriDokumen as $kategori)
                                                            <option value="{{ $kategori->id_kode }}"
                                                                {{ old('kategori_dok') == $kategori->id_kode ? 'selected' : '' }}>
                                                    ...
                                                    <select class="form-select @error('nama_dok') is-invalid @enderror"
                                                        ...
                                                        @foreach ($namaDokumen as $dokumen)
                                                            <option value="{{ $dokumen->id_kode }}"
                                                                {{ old('nama_dok') == $dokumen->id_kode ? 'selected' : '' }}>
                                                                {{ $dokumen->nama_dok }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('penerbit_dok') is-invalid @enderror"
                                                        id="penerbit_dok" name="penerbit_dok" value="{{ old('penerbit_dok') }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('validasi_dok') is-invalid @enderror"
                                                        id="validasi_dok" name="validasi_dok" value="{{ old('validasi_dok') }}"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input jenis-masa-berlaku @error('jenis_masa_berlaku') is-invalid @enderror"
                                                            ...
                                                            {{ old('jenis_masa_berlaku', 'Tetap') == 'Tetap' ? 'checked' : '' }} required>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input jenis-masa-berlaku @error('jenis_masa_berlaku') is-invalid @enderror"
                                                            ...
                                                            {{ old('jenis_masa_berlaku') == 'Perpanjangan' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control tanggal-input @error('tgl_terbit_dok') is-invalid @enderror"
                                                                id="tgl_terbit_dok" name="tgl_terbit_dok" value="{{ old('tgl_terbit_dok') }}" required>
                                                    ...
                                                    <div class="form-group mb-3 tgl-berakhir-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control tanggal-input @error('tgl_berakhir_dok') is-invalid @enderror"
                                                                id="tgl_berakhir_dok" name="tgl_berakhir_dok" value="{{ old('tgl_berakhir_dok') }}">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="masa_berlaku"
                                                    name="masa_berlaku" value="{{ old('masa_berlaku', 'Tetap') }}" readonly>
                                            ...
                                            <div class="form-group mb-3 tgl-peringatan-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control tanggal-input @error('tgl_peringatan') is-invalid @enderror"
                                                        id="tgl_peringatan" name="tgl_peringatan" value="{{ old('tgl_peringatan') }}">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="masa_peringatan"
                                                    name="masa_peringatan" value="{{ old('masa_peringatan', '-') }}" readonly>
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group h-100">
                                                ...
                                                <textarea class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                    name="catatan" rows="4" placeholder="Tambahkan catatan atau keterangan tambahan...">{{ old('catatan') }}</textarea>
                                                @error('catatan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="bg-light p-2 rounded">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('status_dok') is-invalid @enderror"
                                                        ...
                                                        {{ old('status_dok', 'Berlaku') == 'Berlaku' ? 'checked' : '' }} required>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('status_dok') is-invalid @enderror"
                                                        ...
                                                        {{ old('status_dok') == 'Tidak Berlaku' ? 'checked' : '' }}>
