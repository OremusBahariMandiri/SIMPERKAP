            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-boxes me-2"></i>Edit Golongan Barang</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('golongan-barang.update', $golonganBarang->id) }}" method="POST"
                            id="golonganBarangForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card border-secondary mb-4">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form-control" id="id_kode_display"
                                        value="{{ $golonganBarang->id_kode }}" hidden disabled>

                                    <div class="form-group mb-3">
                                        <label for="golongan_brg" class="form-label fw-bold">Golongan Barang</label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                                            <input class="form-control" id="golongan_brg" name="golongan_brg" value="{{ old('golongan_brg', $golonganBarang->golongan_brg) }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                                            <textarea class="form-control" id="ket_brg" name="ket_brg" rows="3">{{ old('ket_brg', $golonganBarang->ket_brg) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
