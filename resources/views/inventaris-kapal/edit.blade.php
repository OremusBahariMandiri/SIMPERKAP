            ...
            <div class="col-md-10">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('inventaris-kapal.update', $inventarisKapal->id) }}" method="POST"
                            enctype="multipart/form-data" id="inventarisKapalForm">
                            @csrf
                            @method('PUT')
                                                ...
                                                <select class="form-select" id="id_kode_05" name="id_kode_05" required>
                                                    ...
                                                    @foreach ($kapal as $item)
                                                        <option value="{{ $item->id_kode }}"
                                                            {{ old('id_kode_05', $inventarisKapal->id_kode_a05) == $item->id_kode ? 'selected' : '' }}>
                                                            {{ $item->nama_kpl }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" id="id_kode_11" name="id_kode_11" required>
                                                    ...
                                                    @foreach ($namaBarang as $item)
                                                        <option value="{{ $item->id_kode }}"
                                                            {{ old('id_kode_11', $inventarisKapal->id_kode_a11) == $item->id_kode ? 'selected' : '' }}>
                                                            {{ $item->nama_brg }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="id_kode_08" name="id_kode_08"
                                                    value="{{ old('id_kode_08', $inventarisKapal->id_kode_08) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="id_kode_09" name="id_kode_09"
                                                    value="{{ old('id_kode_09', $inventarisKapal->id_kode_09) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="id_kode_10" name="id_kode_10"
                                                    value="{{ old('id_kode_10', $inventarisKapal->id_kode_10) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="no_kode_brg"
                                                    name="no_kode_brg"
                                                    value="{{ old('no_kode_brg', $inventarisKapal->no_kode_brg) }}"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="no_kode_brg_subtitusi"
                                                    ...
                                                    value="{{ old('no_kode_brg_subtitusi', $inventarisKapal->no_kode_brg_subtitusi) }}"
                                                    placeholder="Masukkan kode substitusi">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="tipe_brg"
                                                    name="tipe_brg"
                                                    value="{{ old('tipe_brg', $inventarisKapal->tipe_brg) }}"
                                                    placeholder="Masukkan tipe/model barang">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="merek_brg"
                                                    name="merek_brg"
                                                    value="{{ old('merek_brg', $inventarisKapal->merek_brg) }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="satuan_brg"
                                                    name="satuan_brg"
                                                    value="{{ old('satuan_brg', $inventarisKapal->satuan_brg) }}"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="supplier_brg"
                                                    name="supplier_brg"
                                                    value="{{ old('supplier_brg', $inventarisKapal->supplier_brg) }}"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="lokasi_brg"
                                                    name="lokasi_brg"
                                                    value="{{ old('lokasi_brg', $inventarisKapal->lokasi_brg) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="no_pengadaan_brg"
                                                    name="no_pengadaan_brg"
                                                    value="{{ old('no_pengadaan_brg', $inventarisKapal->no_pengadaan_brg) }}"
                                                    placeholder="Nomor dokumen pengadaan">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        @if ($inventarisKapal->file_dok)
                                            <div class="mt-2">
                                                <span class="badge bg-info text-dark">
                                                    <i class="fas fa-file me-1"></i> File saat ini:
                                                    {{ basename($inventarisKapal->file_dok) }}
                                                </span>
                                                <a href="{{ Storage::url($inventarisKapal->file_dok) }}" target="_blank"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_awal"
                                                    name="stock_awal"
                                                    value="{{ old('stock_awal', $inventarisKapal->stock_awal) }}"
                                                    min="0" step="1">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_masuk"
                                                    name="stock_masuk"
                                                    value="{{ old('stock_masuk', $inventarisKapal->stock_masuk) }}"
                                                    min="0" step="1">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_keluar"
                                                    name="stock_keluar"
                                                    value="{{ old('stock_keluar', $inventarisKapal->stock_keluar) }}"
                                                    min="0" step="1">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_limit"
                                                    name="stock_limit"
                                                    value="{{ old('stock_limit', $inventarisKapal->stock_limit) }}"
                                                    min="0" step="1">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control bg-light" id="stock_akhir"
                                                    name="stock_akhir"
                                                    value="{{ old('stock_akhir', $inventarisKapal->stock_akhir) }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
