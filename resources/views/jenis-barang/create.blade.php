        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <span class="fw-bold"><i class="fas fa-box me-2"></i>Tambah Jenis Barang</span>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('jenis-barang.store') }}" method="POST" id="jenisBarangForm">
                        @csrf
                        ...
                        <div class="card border-secondary mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    <label for="jenis_brg" class="form-label fw-bold">Jenis Barang <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-layer-group"></i></span>
                                        <input type="text" class="form-control" id="jenis_brg" name="jenis_brg"
                                            value="{{ old('jenis_brg') }}" required/>
                                    </div>
                                </div>
