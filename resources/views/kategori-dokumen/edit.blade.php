            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-folder me-2"></i>Edit Kategori Dokumen</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kategori-dokumen.update', $kategoriDokumen->id) }}" method="POST"
                            id="kategoriDokumenForm">
                            @csrf
                            @method('PUT')

                            <div class="card border-secondary mb-4">
                                <div class="card-header bg-secondary bg-opacity-25 text-dark">
                                    <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i>Informasi Kategori Dokumen
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <input type="text" class="form-control" id="id_kode_display"
                                        value="{{ $kategoriDokumen->id_kode }}" hidden disabled>
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="kategori_dok" name="kategori_dok"
                                                value="{{ old('kategori_dok', $kategoriDokumen->kategori_dok) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
