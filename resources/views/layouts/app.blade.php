...
<head>
    ...
    <title>SIMPERKAP - Sistem Informasi Manajemen Perkapalan</title>
                        ...
                        <div class="dropdown">
                            <div class="d-flex align-items-center dropdown-toggle" id="userDropdown"
                                ...
                                <div class="me-2 d-none d-md-block text-end">
                                    <h6 class="mb-0 fw-semibold">{{ Auth::user()->nama_kry }}</h6>
                                    <span class="small text-muted">{{ Auth::user()->nik_kry }}</span>
                                </div>
