            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-boxes me-2"></i>Edit Nama Barang</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('nama-barang.update', $namaBarang->id) }}" method="POST"
                            id="namaBarangForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card border-secondary mb-4">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form-control" id="id_kode_display"
                                        value="{{ $namaBarang->id_kode }}" hidden disabled>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="no_kode_brg" name="no_kode_brg"
                                                value="{{ old('no_kode_brg', $namaBarang->no_kode_brg) }}" placeholder="Masukkan kode barang...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_brg" name="nama_brg"
                                                value="{{ old('nama_brg', $namaBarang->nama_brg) }}" placeholder="Masukkan nama barang..." required>
                                        </div>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="id_kode_a08" class="form-label fw-bold">Kategori Barang <span
                                            ...
                                            <select class="form-select" id="id_kode_a08" name="id_kode_a08" required>
                                                ...
                                                @foreach ($kategoriBarangs as $kategori)
                                                    <option value="{{ $kategori->id_kode }}"
                                                        {{ old('id_kode_a08', $namaBarang->id_kode_a08) == $kategori->id_kode ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="id_kode_a09" class="form-label fw-bold">Jenis Barang <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="id_kode_a09" name="id_kode_a09" required>
                                                ...
                                                @foreach ($jenisBarangs as $jenis)
                                                    <option value="{{ $jenis->id_kode }}"
                                                        {{ old('id_kode_a09', $namaBarang->id_kode_a09) == $jenis->id_kode ? 'selected' : '' }}>
                                                        {{ $jenis->jenis_brg }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="id_kode_a10" class="form-label fw-bold">Golongan Barang <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="id_kode_a10" name="id_kode_a10" required>
                                                ...
                                                @foreach ($golonganBarangs as $golongan)
                                                    <option value="{{ $golongan->id_kode }}"
                                                        {{ old('id_kode_a10', $namaBarang->id_kode_a10) == $golongan->id_kode ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" id="keterangan_brg" name="keterangan_brg"
                                                    rows="4" placeholder="Masukkan keterangan barang...">{{ old('keterangan_brg', $namaBarang->keterangan_brg) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
