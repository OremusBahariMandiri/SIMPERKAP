            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('perusahaan.update', $perusahaan->id) }}" method="POST" id="perusahaanForm">
                        @csrf
                        @method('PUT')
                        <input type="text" class="form-control" id="id_kode" name="id_kode" value="{{ old('id_kode', $perusahaan->id_kode) }}" hidden readonly>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_prsh" name="nama_prsh"
                                                    value="{{ old('nama_prsh', $perusahaan->nama_prsh) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="alamat_prsh" name="alamat_prsh"
                                                    rows="4" required>{{ old('alamat_prsh', $perusahaan->alamat_prsh) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" id="tgl_berdiri" name="tgl_berdiri"
                                                    value="{{ old('tgl_berdiri', $perusahaan->tgl_berdiri ? $perusahaan->tgl_berdiri->format('Y-m-d') : '') }}">
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" class="form-control" id="web_prsh" name="web_prsh"
                                                    value="{{ old('web_prsh', $perusahaan->web_prsh) }}">
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="telp_prsh" name="telp_prsh"
                                                    value="{{ old('telp_prsh', $perusahaan->telp_prsh) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="telp_prsh2" name="telp_prsh2"
                                                    value="{{ old('telp_prsh2', $perusahaan->telp_prsh2) }}">
                                            </div>
                                            <div class="form-text text-muted"><i class="fas fa-info-circle me-1"></i>Opsional</div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email_prsh" name="email_prsh"
                                                    value="{{ old('email_prsh', $perusahaan->email_prsh) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email_prsh2" name="email_prsh2"
                                                    value="{{ old('email_prsh2', $perusahaan->email_prsh2) }}">
                                            </div>
                                            <div class="form-text text-muted"><i class="fas fa-info-circle me-1"></i>Opsional</div>
                                        </div>
                                    </div>
