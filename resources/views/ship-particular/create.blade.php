        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <span class="fw-bold"><i class="fas fa-ship me-2"></i>Tambah Ship Particular</span>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('ship-particular.store') }}" method="POST" id="shipParticularForm" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="nama_kpl" name="nama_kpl" required>
                                            ...
                                            @foreach ($kapal as $ship)
                                                <option value="{{ $ship->id_kode }}" {{ old('nama_kpl') == $ship->id_kode ? 'selected' : '' }}>
                                                    {{ $ship->nama_kpl }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="ship_particular_ket" name="ship_particular_ket"
                                                rows="4" placeholder="Masukkan keterangan ship particular...">{{ old('ship_particular_ket') }}</textarea>
                                    </div>
                                </div>
