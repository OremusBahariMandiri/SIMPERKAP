                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_kry"
                                                        name="nama_kry" value="{{ old('nama_kry', $user->nama_kry) }}"
                                                        required>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" id="departemen_kry" name="departemen_kry"
                                                        ...
                                                        <option value="Kesekretariatan"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'Kesekretariatan' ? 'selected' : '' }}>
                                                            Kesekretariatan</option>
                                                        <option value="HRD"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'HRD' ? 'selected' : '' }}>
                                                            HRD</option>
                                                        <option value="Keuangan"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'Keuangan' ? 'selected' : '' }}>
                                                            Keuangan</option>
                                                        <option value="Komersial"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'Komersial' ? 'selected' : '' }}>
                                                            Komersial</option>
                                                        <option value="Operations"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'Operations' ? 'selected' : '' }}>
                                                            Operations</option>
                                                        <option value="HSE"
                                                            {{ old('departemen_kry', $user->departemen_kry) == 'HSE' ? 'selected' : '' }}>
                                                            HSE</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card h-100 border-secondary">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" id="wilker_kry" name="wilker_kry" required>
                                                        ...
                                                        <option value="Samarinda"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Samarinda' ? 'selected' : '' }}>
                                                            Samarinda</option>
                                                        <option value="Balikpapan"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Balikpapan' ? 'selected' : '' }}>
                                                            Balikpapan</option>
                                                        <option value="Surabaya"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Surabaya' ? 'selected' : '' }}>
                                                            Surabaya</option>
                                                        <option value="Lamongan"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Lamongan' ? 'selected' : '' }}>
                                                            Lamongan</option>
                                                        <option value="Gresik"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Gresik' ? 'selected' : '' }}>
                                                            Gresik</option>
                                                        <option value="Samboja"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Samboja' ? 'selected' : '' }}>
                                                            Samboja</option>
                                                        <option value="Bontang"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Bontang' ? 'selected' : '' }}>
                                                            Bontang</option>
                                                        <option value="Makassar"
                                                            {{ old('wilker_kry', $user->wilker_kry) == 'Makassar' ? 'selected' : '' }}>
                                                            Makassar</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="password_kry" class="form-label fw-bold">Password</label>
